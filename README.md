...
- **v1.2.0 (2026-09-03, 当前)**: 客户端私有云协议迁移;门锁/开关/摄像头(默认云端流媒体网关)/对话(呼叫应答·拒绝·挂断·语音回复)实体与服务;临时密码与开门记录事件;单元测试 50 例 + HACS/发布 CI;MIT LICENSE 与免责声明;修复登录会话死锁。(v1.1.0 为开发中间版本,已并入本版本)
